    ...
    <div class="small-container cart-page">
        ...
        <?php
                ...
                echo "<h2 class='text-center text-danger'>Cart is empty</h2>
                        <div class='d-flex justify-content-end mt-4'>
                            <button class='px-3 py-2 border-0 mx-3' style='background-color: #00FF00; color: white;'><a href='product.php' class='mr-2' style='text-decoration: none; color: white;'>Continue shopping</a></button>
                        </div>";
            }
        ?>
    </div>
