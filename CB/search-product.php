...
<div class="side-menu" id="side-menu">
		<ul>
			<li>On Sale<i class="fa fa-angle-right"></i>
				<ul>
					<li><a href="product.php?onSales=1"style="color: #FF0000">Accessory</a></li>
					<li><a href="product.php?onSales=2"style="color: #FF0000">Beds</a></li>
					<li><a href="product.php?onSales=3"style="color: #FF0000">Clothing</a></li>
					<li><a href="product.php?onSales=4"style="color: #FF0000">Food</a></li>
					<li><a href="product.php?onSales=5"style="color: #FF0000">Toys</a></li>
				</ul>
        	</li>
			<?php
				getCategories();
