...
$insert_orders="INSERT INTO user_order (user_id,amount_due,invoice_number,total_products,order_date,order_status) VALUES ($user_id,$subtotal,$invoice_number,$quantity,NOW(),'$status')";
