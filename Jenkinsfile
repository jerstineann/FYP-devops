pipeline {
    ...
    stages {
		...
		// Create network if it doesn't exist
        	...
        	sh 'cd /home/shannen/Downloads && docker build -t db -f db-docker .'// Build the database container image
        	...
        	ssh 'cd /home/shannen/Downloads && docker build -t db -f db-docker .' // Build the web application container image
