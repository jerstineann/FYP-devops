pipeline {
    ...
    stages {
		...
		// Create network if it doesn't exist
        	...
        	sh 'docker build -t db -f /home/shannen/Downloads/db-docker .' // Build the database container image
        	...
        	sh 'docker build -t web -f /home/shannen/Downloads/web-docker .' // Build the web application container image
