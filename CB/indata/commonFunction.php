...
include('connect.php');
                    ...
                    <div class='col-md-4 mb-2'>
                        <div class='card h-100' style='width: 18rem;'>
                            ...
                            <div class='card-body'>
                                ...
                                <a href='product.php?add_to_cart=$product_id' class='btn btn-info' style='background-color: #FF0000; color: white;'>Add to cart</a> 
        ...
        while ($row_data = mysqli_fetch_assoc($result_categories)) {
            ...
            if (mysqli_num_rows($result_subcategories) > 0) {
                ...
                while ($row_subcategory = mysqli_fetch_assoc($result_subcategories)) {
                    ...
                    echo "<li><a href='product.php?subcategory=$subcategory_id' style='color: #FF0000; text-decoration: none;'>$subcategory_title</a></li>";
                }
                echo "</ul>";
            }
            echo "</li>";
    ...
    function getBrands(){
		...
		while($row_data=mysqli_fetch_assoc($result_brands)){
			...
			echo "
            <li class='nav-item'><a href='product.php?brand=$brand_id' style='color: #FF0000; text-decoration: none;'>$brand_title</a></li>";
		}
        echo "</ul>";
    }
